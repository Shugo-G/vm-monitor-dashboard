...
SCRIPT_PATH="$SCRIPT_DIR/reporter_produccion.py"
DOWNLOAD_URL="http://gis.dposs.gob.ar/reporter_produccion.py"
...
EOF
    ...
    # Intentar reiniciar cron (nombre varía según distro)
